...
import { HeaderOneComponent } from 'src/app/feature-module/common/headers/header-one/header-one.component';
import { SideMenuThreeComponent } from 'src/app/feature-module/common/side-menus/side-menu-three/side-menu-three.component';
import { SettingsMenuComponent } from 'src/app/feature-module/common/settings-menu/settings-menu.component';
import { SideMenuOneComponent } from 'src/app/feature-module/common/side-menus/side-menu-one/side-menu-one.component';
import { UserInfoDTO } from 'src/app/core/models/auth/LoginDTO';
import { Subscription } from 'rxjs';

@Component({
  selector: 'app-super-admin.app-component',
  standalone: true,
  imports: [RouterModule,CommonModule,HeaderOneComponent,SideMenuThreeComponent,SettingsMenuComponent,SideMenuOneComponent],
  templateUrl: './super-admin.app-component.component.html',
  styleUrl: './super-admin.app-component.component.scss',
  encapsulation: ViewEncapsulation.None,
})
export class SuperAdminAppComponentComponent implements OnDestroy {
  public toggle = false;
